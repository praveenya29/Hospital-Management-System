<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      $name = $_POST['user'];
      $pass = $_POST['pass'];
      $sql = "SELECT * from receptionist where username='$name'";
      ...
      if ($num == 1) {
        ...
        $sql="INSERT INTO `receptionist` (`username`, `password`) VALUES ('$name', '$pass')";
        $sql2="INSERT INTO `user` (`username`, `password`, `type`) VALUES ('$name', '$pass', 'Receptionist');";
        $result = mysqli_query($con,$sql);
...
<?php
    if($alert){
        ...
        <strong>Success!</strong> Receptionist has been added!
    ...
    if($showError){
        ...
        <strong>Oops!</strong> Receptionist already exists!
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>';
...
?>
<form class="container md-4" action="addReceptionist.php" method="POST">
    <div class="form-row">
